...
*/}}
{{- define "redis.image" -}}
{{ include "common.images.image" (dict "imageRoot" .Values.redisimage "global" .Values.global) }}
{{- end -}}
...
{{- include "common.images.pullSecrets" (dict "images" (list .Values.redisimage .Values.sentinel.image .Values.metrics.image .Values.volumePermissions.image .Values.sysctl.image) "global" .Values.global) -}}
{{- end -}}
...
{{- include "common.warnings.rollingTag" .Values.redisimage }}
